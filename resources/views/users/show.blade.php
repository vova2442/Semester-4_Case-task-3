...
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            @auth <!-- Показываем кнопки только авторизованным пользователям -->
                @if(Auth::id() !== $user->id) <!-- Не показываем кнопки на своей странице -->
                    @if ($isFollowing)
                        <!-- Форма для отписки -->
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @empty
                <p>У этого пользователя еще нет постов.</p>
            @endforelse
        </div>
    </div>
</x-app-layout>